...
public class ResponseEntityTestController {
    ...
    public ResponseEntityTestController() {
        ...
        users.add(new UserDTO(2, "user02", "pass01", "유관순", new java.util.Date()));
        users.add(new UserDTO(3, "user03", "pass01", "이순신", new java.util.Date()));
    }
    ...
    public ResponseEntity<ResponseMessage> findUserByNo(@PathVariable int userNo) {
        ...
        /*설명. 요청 리소스(회원 번호와 일치하는 회원 한 명)을 추출*/
    ...
    /*설명.
    *  @RequestParam과 달리 json 문자열이 핸들러 메소드로 넘어올 때는 @RequestBody를 붙이고 받아내야 한다.
    *  json 문자열의 각 프로퍼티 별로 받을 수도 있지만 한번에 하나의 타입으로 다 받아낼 때는 커맨드 객체(UserDTO)를
    ...
    * */
    ...
    public ResponseEntity<?> registUser(@RequestBody UserDTO newUser) {
        ...
        /*설명. auto_increment 개념을 컬렉션 마지막에 있는 회원 번호 + 1로 해서 newUser에 추가*/
