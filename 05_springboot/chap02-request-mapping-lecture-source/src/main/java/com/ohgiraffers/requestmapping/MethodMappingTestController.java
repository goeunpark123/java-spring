...
public class MethodMappingTestController {
    ...
    /*설명. 핸들러 메소드(어노테이션을 활용해서 요청 방식 및 경로에 따라 각각 메소드가 작성)*/
    @RequestMapping(value = "/menu/regist")             // GET 요청 뿐 아니라 다른 요청 방식도 처리
//    @RequestMapping(value = "/menu/regist", method = RequestMethod.GET)
    public String registMenu(Model model) {                 // Model은 응답할 페이지의 재료를 담는 객체
        ...
        /*설명. 핸들러 메소드에서 반환하는 String 값은 templates에 있는 view(html 파일)의 이름*/
