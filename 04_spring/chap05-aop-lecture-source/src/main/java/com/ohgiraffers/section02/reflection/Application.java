...
public class Application {
    public static void main(String[] args) {
        ...
        *  스프링 프레임워크, 마이바티스, 하이버네이트, jackson 등의 라이브러리에서 사용
        *  스프링에서는 런타임 시 개발자가 등록한 빈을 애플리케이션 내에서 사용할 수 있게 하는 기술*/

        /*필기.
        *  reflection은 강력한 도구이지만 무분별하게 사용해서는 안된다.
        *   1. 오버헤드 발생: 성능 저하가 발생할 수 있기 때문에 민감한 애플리케이션에는 사용하지 않는다.
        *   2. 캡슐화 저해: private으로 설정한 member(또는 필드)에 접근 가능하기 때문에 코드 기능이 저하되며 여러 문제 야기*/
        ...
        try {
            Account acc = (Account) constructors[0].newInstance("20", "110-223-123445", "1234", 10000);
