...
public class PrimaryKeyMappingTests {
    ...
    *   - GenerationType.SEQUENCE: 데이터베이스 시퀀스 객체 사용
    *   - GenerationType.TABLE: 키 생성 테이블 사용
    *   - GenerationType.AUTO: 자동 선택(MySQL의 IDENTITY 또는 ORACLE의 SEQUENCE)*/
    ...
    public void 식별자_매핑_테스트() {
        ...
        member2.setEmail("ho@gmail.com");
        member2.setAddress("서울 강남구");
